...
MODEL_NAME = os.getenv("MODEL_NAME", "mock-avalara-tax-code")
...
def main():
    ...
    with mlflow.start_run(run_name=f"{MODEL_NAME}-{DATASET_VERSION}") as run:
        mlflow.set_tags({
            ...
            "source.repository": "https://github.com/nolet7/ai-platform-lab.git",
        ...
        client = MlflowClient()
        client.set_registered_model_tag(MODEL_NAME, "owner", "tax-ml-team")
